...
ForEach ($Item in $Args) {
    ...
    If (Test-Path -LiteralPath $Item -PathType Leaf) {
     ...
     #CATEGORY-EMP (Must be on line 1 of your text file, don't make typos else it will be skipped)
     ...
     #This next line isn't mandatory, just special character replacement, else the torrent will be named after the file without the extension or the top folder by default.
     ...
     #Closing tags for your bbcode (those you want to come after the screens)
