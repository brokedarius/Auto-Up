...
ForEach ($Item in $Args) {
    ...
    If (Test-Path -LiteralPath $Item -PathType Leaf) {
         ...
         #SCREENSHOTS UPLOADING AND APPENDING INSIDE TXT FILE (if you need other formats or suffixes, just add lines or change values in this next part)   
     ...
     #This next line isn't mandatory, just special character replacement for the direct links, you can comment out if you never use it
     ...
     #CATEGORY (Must be on line 1 of your text file, don't make typos)
