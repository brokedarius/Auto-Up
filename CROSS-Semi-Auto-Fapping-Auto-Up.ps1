...
ForEach ($Item in $Args) {
    ...
    If (Test-Path -LiteralPath $Item -PathType Leaf) {
     ...
     #TORRENT CREATION (You can comment out these 2 lines and create torrents on your own as well, set by default to private, verbose mode and piece size 8MB)
     ...
     #PRESENTATION (Make sure there are no BBCode errors)

     ### Creating the form with the Windows forms namespace, you will find your bbcode links in the text box waiting for you.
     ...
     $CategoryPB = Read-Host "Enter your torrent category for PB";
     ...
     If ($DupeCheck = $ChromeDriver.FindElementByXpath('/html/body/div[2]/div[3]/div/form/div[2]').text) {
         ...
         If ($Answer -Contains "Yes") { 
             ...
             $ChromeDriver.FindElementByXpath('/html/body/div[2]/div[3]/div/form/div[3]/div/input').Click();
